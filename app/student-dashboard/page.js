...
export const StudentDashboardPage = () => {
    ...
    useEffect(() => {
        ...
        axios.post('https://flipr-yi8b.onrender.com/api/present_student',{student_id: user.userID})
            .then(response => {
    ...
    useEffect(() => {
        ...
        axios.post('https://flipr-yi8b.onrender.com/api/absent_student',{student_id: user.userID})
            .then(response => {
