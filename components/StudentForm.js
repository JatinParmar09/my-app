  ...
  return (
    ...
    <form onSubmit={handleFormSubmit} className="fixed top-0 left-0  w-full h-full flex items-center justify-center bg-black bg-opacity-50">
        <div className="bg-white p-6 w-[50vw] rounded shadow-lg ">
          <div className=''>
          <button className='top-2 right-2 bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 rounded' type="button" onClick={() => props.setIsFormShown(false)}>Close</button>
          </div>
          ...
          <input
            type="number"
            className=' block w-full bg-white rounded-md border-0 p-1 pl-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 sm:text-sm sm:leading-6 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none'
            id="student_id"
            autoComplete="off"
